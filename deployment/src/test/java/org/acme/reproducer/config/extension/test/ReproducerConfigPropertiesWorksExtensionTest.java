...
public class ReproducerConfigPropertiesWorksExtensionTest {

    // Start unit test with your extension loaded
    @RegisterExtension
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addAsResource(new FileAsset(new File(ReproducerConfigPropertiesWorksExtensionTest.class.getClassLoader().getResource("application_works.properties").getFile())), "application.properties")
            );
